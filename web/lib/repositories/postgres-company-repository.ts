...
function mapComparisonFromCardRow(row: CompanyCardRow): ComparisonSummary | null {
  ...
  return {
    ...
    financialConditionShareChange: row.financial_condition_share_change,
    financialConditionShareChangeLabel: row.financial_condition_share_change_label,
    financialConditionTopicMixChange: row.financial_condition_topic_mix_change,
