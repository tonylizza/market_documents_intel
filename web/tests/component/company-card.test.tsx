...
describe("CompanyCard", () => {
  ...
  it("shows the disclosure-change magnitude label alongside its quality label -- never one without the other", () => {
    const card = makeCard({
      ...
      financialConditionShareChange: null,
      financialConditionShareChangeLabel: null,
      financialConditionTopicMixChange: null,
      governanceShareChange: null,
      governanceShareChangeLabel: null,
      governanceTopicMixChange: null,
