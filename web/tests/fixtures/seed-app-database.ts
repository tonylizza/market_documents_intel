        ...
        await client.query(
          `INSERT INTO app.report_comparisons
             (id, publication_id, source_report_pair_id, company_id, earlier_report_id, later_report_id,
              ...
              financial_condition_share_change, financial_condition_share_change_label,
              financial_condition_topic_mix_change,
              governance_share_change, governance_share_change_label, governance_topic_mix_change,
              governance_share_earlier, governance_share_later,
              governance_hits_earlier, governance_hits_later,
              custom_taxonomy_hits_earlier, custom_taxonomy_hits_later,
              feature_eligible_primary_words_earlier, feature_eligible_primary_words_later,
              financial_condition_hits_earlier, financial_condition_hits_later,
              uncertainty_hits_earlier, uncertainty_hits_later,
              financial_condition_count_change_per_1000, financial_condition_topic_change,
              financial_condition_supporting_hits, financial_condition_opposing_hits,
              financial_condition_change_consistency_ratio, financial_condition_largest_passage_share,
              governance_count_change_per_1000, governance_topic_change,
              governance_supporting_hits, governance_opposing_hits,
              governance_change_consistency_ratio, governance_largest_passage_share,
              uncertainty_count_change_per_1000, uncertainty_topic_change,
              uncertainty_supporting_hits, uncertainty_opposing_hits,
              uncertainty_change_consistency_ratio, uncertainty_largest_passage_share,
              positive_rate_change, negative_rate_change,
           ...
           VALUES ($1, $2, $3, $4, $5, $6, $7, $8, 12, $9, false, false, $10, false,
                   ...
                   0.021, 'Minimal increase',
                   0.05,
                   0.021, 'Minimal increase', 0.03,
                   0.3, 0.321,
                   30, 32,
                   100, 100,
                   20000, 20500,
            ...
            await client.query(
              `INSERT INTO app.discovery_items
               ...
               VALUES ($1, $2, $3, $4, 'largest_uncertainty_increase', $5,
                       1.2, 1, 80.0, 'largest_uncertainty_increase', 'uncertainty_topic_change', 0.9,
